package com.jk.eis.commen.okhttp.response;
...
import com.jk.eis.commen.exception.OkHttpException;
import com.jk.eis.commen.okhttp.DisposeDataHandle;
import com.jk.eis.commen.okhttp.listener.DisposeDownloadListener;
...
public class CommonFileCallback implements Callback {
	...
	private File handleResponse(Response response) {
		...
		double sumLength = 0;
		//如果相应文件夹不存在，则创建文件夹
		File d =new File(mFilePath.substring(0,mFilePath.lastIndexOf("/")));    
