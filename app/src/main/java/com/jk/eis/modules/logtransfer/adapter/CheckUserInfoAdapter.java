...
public class CheckUserInfoAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = mInflater.inflate(R.layout.logcheck_item, null);
			holder.draweeView = (SimpleDraweeView) convertView.findViewById(R.id.id_logcheck_image_photo);
			holder.name = (TextView) convertView.findViewById(R.id.id_logcheck_tv_name);
			holder.username = (TextView) convertView.findViewById(R.id.id_logcheck_tv_username);
