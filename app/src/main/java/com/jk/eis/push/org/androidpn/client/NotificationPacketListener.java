...
import com.jk.eis.push.org.androidpn.client.IQ.DeliverConfirmIQ;
    ...
    public void processPacket(Packet packet) {
        ...
        if (packet instanceof NotificationIQ) {
            ...
            if (notification.getChildElementXML().contains(
                ...
                final String notificationApiKey = notification.getApiKey();
                final String notificationTitle = notification.getTitle();
                final String notificationMessage = notification.getMessage();
                //                String notificationTicker = notification.getTicker();
                final String notificationUri = notification.getUri();
                final String notificationImageUrl = notification.getImageUrl();
                
                //获取notificationHistory对象
                ...
                intent.putExtra(Constants.NOTIFICATION_IMAGE_URI, notificationImageUrl);
